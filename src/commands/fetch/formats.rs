...
"#,
    ...
    // Additional sections from config.json
    let projects_string = match &about.projects {
    ...
    let skills_string = match &about.skills {
        Some(skills) => format!(
    ...
    let achievements_string = match &about.achievements {
        Some(ach) => ach
            .iter()
    ...
    let responsibilities_string = match &about.responsibilities {
        Some(res) => res
            .iter()
